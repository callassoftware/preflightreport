...
// Show additional nohits
var sShowNoHits = true;

// Show Trimbox and Cropbox
var sShowPageDimensions = true;

// Show missing fonts
var sShowMissingFonts = true;

// Show output intent
var sShowOutputIntent = true;
...
var sColorSummaryBackground_success = "#F0FFF0";
var sColorSummaryBackground_error = "#FFF1F0";
...
// Units
//-------------------------------------------------------------------------------------------------
// Show the page dimensions in the given unit. Default: unitUnits.point
// unitUnits.point: Points
// unitUnits.mm: Millimeters
// unitUnits.inch: Inches
var sUnitPageDimensions = unitUnits.mm;
// Display name for the above given unit
var sUnitPageDimensionsString = "mm";
// Unit for color coverage, possible: sqcm, sqin, sqm
var sUnitColorCoverage = "sqcm";
