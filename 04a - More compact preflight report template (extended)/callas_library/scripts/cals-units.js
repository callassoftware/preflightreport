...
var squareUnits = {
    cm2:            { value: 1, cm2Factor: 1,           in2Factor: 0.155 },
    m2:             { value: 2, cm2Factor: 10000,       in2Factor: 1550.003 },
    in2:            { value: 3, cm2Factor: 6.4516,      in2Factor: 1 }
};

Object.freeze(unitUnits);
Object.freeze(squareUnits);
...
// Converts the incoming value in cm2 to in2
//
function unitConvertCm2ToIn2( inCm2 ) {

    return inCm2 * squareUnits.cm2.in2Factor;

}

// Converts the incoming value in in2 to cm2
//
function unitConvertIn2Cm2To( inIn2 ) {

    return inIn2 * squareUnits.in2.cm2Factor;

}

// Converts the incoming value in cm2 to m2
//
function unitConvertCm2ToM2( inM2) {

    return inM2 / squareUnits.m2.cm2Factor;
